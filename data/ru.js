exports.default = {
	...
	aboutMe: 'Обо мне',
	aboutMeText: `
		<p>13+ лет опыта в разработке программного обеспечения и управлении командами в стартапах и крупных компаниях 
		...
		(Vue, Angular, React) и DevOps (Gitlab CI, AWS, Terraform, Angular, Docker), что позволяет мне подходить к 
